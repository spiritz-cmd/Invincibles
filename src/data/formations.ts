...
export const FORMATIONS: Record<string, Formation> = {
  '4-3-3': {
    ...
    slots: [
      ...
      { id: 'LW', label: 'LW', x: 15, y: 25, group: 'ATT', accepts: ['LW', 'LM', 'AM'] },
      { id: 'ST', label: 'ST', x: 50, y: 18, group: 'ATT', accepts: ['ST', 'CF', 'AM'] },
      { id: 'RW', label: 'RW', x: 85, y: 25, group: 'ATT', accepts: ['RW', 'RM', 'AM'] },
    ],
  },
  '4-4-2': {
    name: '4-4-2',
  ...
  '4-2-3-1': {
    ...
    slots: [
      ...
      { id: 'LW', label: 'LW', x: 18, y: 38, group: 'MID', accepts: ['LW', 'LM', 'AM'] },
      { id: 'AM', label: 'AM', x: 50, y: 35, group: 'MID', accepts: ['AM', 'CM', 'ST'] },
      { id: 'RW', label: 'RW', x: 82, y: 38, group: 'MID', accepts: ['RW', 'RM', 'AM'] },
      { id: 'ST', label: 'ST', x: 50, y: 18, group: 'ATT', accepts: ['ST', 'CF', 'AM'] },
    ],
  },
  '4-5-1': {
  ...
  '3-4-3': {
    ...
    slots: [
      ...
      { id: 'LW', label: 'LW', x: 18, y: 25, group: 'ATT', accepts: ['LW', 'LM', 'AM'] },
      { id: 'ST', label: 'ST', x: 50, y: 18, group: 'ATT', accepts: ['ST', 'CF', 'AM'] },
      { id: 'RW', label: 'RW', x: 82, y: 25, group: 'ATT', accepts: ['RW', 'RM', 'AM'] },
    ],
  },
  '3-5-2': {
    name: '3-5-2',
